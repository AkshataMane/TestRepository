     ...
     public void startApp() throws InterruptedException
      {
		...
		Thread.sleep(2000);
  		...
  		driver.findElement(By.xpath("/html/body/div/div/div[4]/div[5]/div[1]/div/ul/div[1]/li[1]")).click();
	  		...
	  		Thread.sleep(2000);
	  		System.out.println("Karnataka"+l1);
	 		...
	 		Thread.sleep(2000);
  	  		...
  	  		Thread.sleep(2000);
  	  		System.out.println("Ker"+l3);
  	  		
  	  		if(pen.equalsIgnoreCase("Pending") && ((l3).contains(ker))) {
	 		...
	 		Thread.sleep(2000);
	  		...
	  		driver.findElement(By.xpath("/html/body/div/div/div[4]/div[5]/div[1]/div/ul/div[1]/li[1]")).click();
		  		...
		  		Thread.sleep(2000);
		  		System.out.println("Pen="+pen);
		  		 kar = driver.findElement(By.xpath("/html/body/div/div/div[5]/div[15]/div[2]")).getText();
		  		Thread.sleep(2000);
		  		System.out.println("West Bengal"+l4);
		  		
		  		if(pen.equalsIgnoreCase("Pending") && ((l4).contains(kar))) {
		 			System.out.println(pen+kar+" Filter working");
		 		}else {
		 			System.out.println(pen+kar+"CourtType Filter FAILED");
		 		}
		 		...
		 		driver.findElement(By.xpath("/html/body/div/div/div[2]/div/div[3]/div[2]/ul/li[5]/h3")).click();
		  		...
		  		driver.findElement(By.xpath("/html/body/div/div/div[4]/div[5]/div[1]/div/ul/div[1]/li[1]")).click();
			  		...
			  		System.out.println("Pen="+pen);
			  		 kar = driver.findElement(By.xpath("/html/body/div/div/div[5]/div[15]/div[2]")).getText();
			  		Thread.sleep(2000);
			  		System.out.println("Maharashtra"+l5);
			  		
			  		if(pen.equalsIgnoreCase("Pending") && ((l5).contains(kar))) {
			 			System.out.println(pen+kar+" Filter working");
			 		}else {
			 			System.out.println(pen+kar+"CourtType Filter FAILED");
			 		}
