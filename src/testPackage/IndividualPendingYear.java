...
public class IndividualPendingYear {
  	     ...
  	     public void PenRegion() throws InterruptedException
  	     {
  	  	...
  	  	//year
  			...
  			String l1 = driver.findElement(By.xpath("/html/body/div/div/div[2]/div/div[4]/div[2]/ul/li[1]/h3")).getText();
  	  		...
  	  		String l4 = driver.findElement(By.xpath("/html/body/div/div/div[2]/div/div[4]/div[2]/ul/li[4]/h3")).getText();
  	  	...
  	  	//2017
  	  		...
  	  		driver.findElement(By.xpath("/html/body/div/div/div[4]/div[5]/div[1]/div/ul/div[1]/li[1]")).click();
  		  		...
  		  		if(pen.equalsIgnoreCase("Pending") && ((kar).contains(l1))) {
  		 	...
  		 	//2018
  	  	  		...
  	  	  		driver.findElement(By.xpath("/html/body/div/div/div[4]/div[5]/div[1]/div/ul/div[1]/li[1]")).click();
  	  		  		...
  	  		  		if(pen.equalsIgnoreCase("Pending") && ((kar).contains(l2))) {
  	  		 			System.out.println(pen+kar+" Filter working");
  	  		 		}else {
  	  		 			System.out.println(pen+kar+"CourtType Filter FAILED");
  	  		 		}
  	  		 	...
  	  		 	//2016
  	  	  	  		...
  	  	  	  		driver.findElement(By.xpath("/html/body/div/div/div[4]/div[5]/div[1]/div/ul/div[1]/li[1]")).click();
  	  	  		  		...
  	  	  		  		if(pen.equalsIgnoreCase("Pending") && ((kar).contains(l3))) {
  	  	  		 			System.out.println(pen+kar+" Filter working");
  	  	  		 		}else {
  	  	  		 			System.out.println(pen+kar+"CourtType Filter FAILED");
  	  	  		 		}
  	    	  		 	...
  	    	  		 	//2016
  	  	  	  	  		...
  	  	  	  	  		driver.findElement(By.xpath("/html/body/div/div/div[4]/div[5]/div[1]/div/ul/div[1]/li[1]")).click();
  	  	  	  		  		...
  	  	  	  		  		if(pen.equalsIgnoreCase("Pending") && ((kar).contains(l4))) {
  	  	  	  		 			System.out.println(pen+kar+" Filter working");
  	  	  	  		 		}else {
  	  	  	  		 			System.out.println(pen+kar+"CourtType Filter FAILED");
  	  	  	  		 		}
