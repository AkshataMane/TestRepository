...
public class IndividualFilter2CourtType {
	...
	public static WebDriver driver;
     ...
     public void NatDeb() throws InterruptedException
     {
		...
		Thread.sleep(2000);
  		...
  		Thread.sleep(2000);
  		String msg = driver.findElement(By.xpath("/html/body/div/div/div[5]/div[7]/div[2]")).getText();
 		System.out.println("msg="+msg);			
 		msg = msg.trim();
 		if(("District Court Tribunal").contains(msg)) {
 			System.out.println(" CourtType Filter working");
 		}else {
 			System.out.println("CourtType Filter FAILED");
 		}
